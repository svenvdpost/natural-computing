...
class Simulation:
    ...
    # ---- GENETIC ----
    def init_genetic(self, genetic_params):
        self.genetic = Genetic.Genetic(self, genetic_params["mutation_rate"], genetic_params["mutation_scale"])
