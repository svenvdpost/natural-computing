...
class Simulation:
    ...
    def init_predators(self):
        ...
        boids = Predator.Predators(num_predator, num_prey, scale, width, height, alignment_distance, cohesion_distance, separation_distance, hunting_distance, elimination_distance,
